...
__start:
  ...
  # load your args
  mv a0, s0 # load the address of the first node in a0
...
printMeAndRecurse:
  ...
  li a0, 11                      # prepare for print string syscall
  ecall
  lw  a0, 4(t0)                  # a0 gets address of next node
  j print_list                   # recurse. We don't have to use jal,
                                 # because we already have where we want
                                 # to return to in ra
